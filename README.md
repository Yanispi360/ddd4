...
task.spawn(function()
	while true do
		OrionLib.RainbowHue = (OrionLib.RainbowHue + 0.005) % 1
		local rc = Color3.fromHSV(OrionLib.RainbowHue, 0.8, 1)
		local t = OrionLib.Themes[OrionLib.SelectedTheme]
		if t then
			t.Stroke = rc
			t.Accent = rc
			t.Divider = Color3.fromHSV(OrionLib.RainbowHue, 0.6, 0.5)
			pcall(function() OrionLib:SetTheme() end)
		end
		task.wait(0.05)
	end
end)
